...
Распакуйте **всю папку** из `output/ZaOdnimStolom-Windows-v0.3.1.zip`, запустите Steam, затем `ZaOdnimStolom.exe`. Для онлайна нужны разные Steam-аккаунты и ПК. Без Steam доступна игра за одним ПК. Версия баланса и PDF остаётся 0.3.0; патч 0.3.1 меняет только представление и управление.

- Unity-проект: `SummonersTable`, редактор **6000.3.21f1**, Windows Build Support.
- Локальная сборка: `Builds/Windows-v0.3.1/ZaOdnimStolom.exe`.
