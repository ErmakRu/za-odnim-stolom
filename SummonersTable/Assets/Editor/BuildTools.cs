...
namespace SummonersTable.Editor
{
    public static class BuildTools
    {
        ...
        public static void BuildWindows()
        {
            ...
            PlayerSettings.companyName="GameJams";PlayerSettings.productName="Za odnim stolom";PlayerSettings.bundleVersion="0.3.0";
            ...
            string output=Path.GetFullPath("../Builds/Windows-v0.3.0");Directory.CreateDirectory(output);
