...
namespace SummonersTable.Editor
{
    public static class BuildTools
    {
        ...
        public static void BuildWindows()
        {
            ...
            var camera=new GameObject("2D Camera").AddComponent<Camera>();camera.orthographic=true;
            ...
            PlayerSettings.companyName="GameJams";PlayerSettings.productName="Za odnim stolom";PlayerSettings.bundleVersion="0.1.0";
            ...
            string output=Path.GetFullPath("../Builds/Windows-v0.1.0");Directory.CreateDirectory(output);
            ...
            string pdf=Path.GetFullPath("../output/pdf/arena-test-decks-v0.1.pdf");
