...
namespace SummonersTable
{
    ...
    {
        public static bool Ready(PlayerState p,LobbyMember m,string matchId){return m.isBot&&p==null&&m.ready||p!=null&&p.connected&&(p.postMatchChoice=="again"||p.postMatchChoice=="deck"&&m.ready&&m.readyMatch==matchId);}
